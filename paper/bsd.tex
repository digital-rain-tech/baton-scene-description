...
The Baton Scene Description schema was developed in connection with Storming Teacup Studios as part of the Baton directing interface system. The originating insight---that a director's embodied performance should be captured as structured, machine-readable data for AI scene generation---came from JK Fidden, Founder of Storming Teacup Studios. JK Fidden contributed the directorial domain expertise, cinematic vocabulary, and conceptual framework that grounds the schema design.
